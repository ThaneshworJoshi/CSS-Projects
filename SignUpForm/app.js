document.querySelector(".banner-btn").addEventListener("click", () => {
  ...
  document.querySelector(".container").style.background = "#cc6ccf";
});
...
document.querySelector(".x-btn").addEventListener("click", () => {
  ...
  document.querySelector(".container").style.cssText =
    "background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.6)),url(images/bg2.avif) center no-repeat; background-size: cover"; 
});
